...
class GQNTrainer(Trainer):
    ...
    def __init__(self, sess, env, brain_name, trainer_parameters, training, seed):
        ...
        self.param_keys = ['brain_to_imitate', 'batch_size', 'time_horizon', 'graph_scope',
                           'summary_freq', 'max_steps', 'batches_per_epoch', 'hidden_units',
        ...
        super(GQNTrainer, self).__init__(sess, env, brain_name, trainer_parameters, training)
